...
func gatewayDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.EdgeDeviceDeleteRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.Error(w, err)
			return
		}

		l := logic.NewGatewayDeleteLogic(r.Context(), svcCtx)
		resp, err := l.GatewayDelete(&req)
